...
public class RootsCache {
    ...
    public void updateAsync() {
        ...
        mRecentsRoot.derivedIcon = top.itmp.documentsui.R.drawable.ic_root_recent;
        mRecentsRoot.flags = Root.FLAG_LOCAL_ONLY | Root.FLAG_SUPPORTS_CREATE
                | Root.FLAG_SUPPORTS_IS_CHILD;
        mRecentsRoot.title = mContext.getString(top.itmp.documentsui.R.string.root_recent);
