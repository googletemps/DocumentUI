...
import static top.itmp.documentsui.BaseActivity.State.SORT_ORDER_DISPLAY_NAME;
import static top.itmp.documentsui.BaseActivity.State.SORT_ORDER_LAST_MODIFIED;
import static top.itmp.documentsui.BaseActivity.State.SORT_ORDER_SIZE;
    ...
    public final DirectoryResult loadInBackground() {
        ...
        try {
            ...
            if (cursor.moveToFirst()) {
                userMode = getCursorInt(cursor, RecentsProvider.StateColumns.MODE);
            }
        } finally {
            IoUtils.closeQuietly(cursor);
        }
