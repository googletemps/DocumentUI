...
public class PickFragment extends Fragment {
    ...
    public static void show(FragmentManager fm) {
        ...
        ft.replace(top.itmp.documentsui.R.id.container_save, fragment, TAG);
    ...
    public View onCreateView(
        ...
        mContainer = inflater.inflate(top.itmp.documentsui.R.layout.fragment_pick, container, false);
    ...
    private void updateView() {
        switch (mAction) {
            case BaseActivity.State.ACTION_OPEN_TREE:
                mPick.setText(top.itmp.documentsui.R.string.button_select);
                mCancel.setVisibility(View.GONE);
                break;
            case BaseActivity.State.ACTION_OPEN_COPY_DESTINATION:
                mPick.setText(top.itmp.documentsui.R.string.button_copy);
