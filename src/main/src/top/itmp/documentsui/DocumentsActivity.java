...
import static top.itmp.documentsui.BaseActivity.State.ACTION_OPEN_COPY_DESTINATION;
import static top.itmp.documentsui.BaseActivity.State.ACTION_OPEN_TREE;
import static top.itmp.documentsui.DirectoryFragment.ANIM_DOWN;
import static top.itmp.documentsui.DirectoryFragment.ANIM_NONE;
import static top.itmp.documentsui.DirectoryFragment.ANIM_UP;
...
import top.itmp.documentsui.model.DurableUtils;
...
public class DocumentsActivity extends BaseActivity {
    ...
    public void onCreate(Bundle icicle) {
        ...
        setContentView(top.itmp.documentsui.R.layout.activity);

        final Context context = this;
        final Resources res = getResources();
        mShowAsDialog = res.getBoolean(top.itmp.documentsui.R.bool.show_as_dialog);
        ...
        if (mShowAsDialog) {
            ...
            a.width = (int) res.getFraction(top.itmp.documentsui.R.dimen.dialog_width, size.x, size.x);

            getWindow().setAttributes(a);

        } else {
            // Non-dialog means we have a drawer
            mDrawerLayout = (DrawerLayout) findViewById(top.itmp.documentsui.R.id.drawer_layout);

            mDrawerToggle = new ActionBarDrawerToggle(this, mDrawerLayout,
                    top.itmp.documentsui.R.drawable.ic_hamburger, top.itmp.documentsui.R.string.drawer_open, top.itmp.documentsui.R.string.drawer_close);

            mDrawerLayout.setDrawerListener(mDrawerListener);

            mRootsDrawer = findViewById(top.itmp.documentsui.R.id.drawer_roots);
        }

        mDirectoryContainer = (DirectoryContainerView) findViewById(top.itmp.documentsui.R.id.container_directory);

        mState = (icicle != null)
                ? icicle.<State>getParcelable(EXTRA_STATE)
                : buildDefaultState();

        mToolbar = (Toolbar) findViewById(top.itmp.documentsui.R.id.toolbar);
        mToolbar.setTitleTextAppearance(context,
                android.R.style.TextAppearance_DeviceDefault_Widget_ActionBar_Title);

        mStackAdapter = new StackAdapter();
        mStackListener = new ItemSelectedListener();
        mToolbarStack = (Spinner) findViewById(top.itmp.documentsui.R.id.stack);
        mToolbarStack.setOnItemSelectedListener(mStackListener);

        mRootsToolbar = (Toolbar) findViewById(top.itmp.documentsui.R.id.roots_toolbar);
        ...
        if (mState.action == ACTION_MANAGE || mState.action == ACTION_BROWSE) {
            if (mShowAsDialog) {
                findViewById(top.itmp.documentsui.R.id.container_roots).setVisibility(View.GONE);
            } else {
    ...
    public void updateActionBar() {
        if (mRootsToolbar != null) {
            ...
            if (prompt != null) {
                ...
                if (mState.action == ACTION_OPEN ||
                    ...
                    mState.action == ACTION_OPEN_TREE) {
                    mRootsToolbar.setTitle(top.itmp.documentsui.R.string.title_open);
                } else if (mState.action == ACTION_CREATE ||
                           mState.action == ACTION_OPEN_COPY_DESTINATION) {
                    mRootsToolbar.setTitle(top.itmp.documentsui.R.string.title_save);
                }
            }
        }
        ...
        if (!mShowAsDialog && mDrawerLayout.getDrawerLockMode(mRootsDrawer) ==
            ...
            mToolbar.setNavigationIcon(top.itmp.documentsui.R.drawable.ic_hamburger);
            mToolbar.setNavigationContentDescription(top.itmp.documentsui.R.string.drawer_open);
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        final MenuItem createDir = menu.findItem(top.itmp.documentsui.R.id.menu_create_dir);
        final MenuItem grid = menu.findItem(top.itmp.documentsui.R.id.menu_grid);
        final MenuItem list = menu.findItem(top.itmp.documentsui.R.id.menu_list);
        final MenuItem advanced = menu.findItem(top.itmp.documentsui.R.id.menu_advanced);
        final MenuItem fileSize = menu.findItem(top.itmp.documentsui.R.id.menu_file_size);
        final MenuItem settings = menu.findItem(top.itmp.documentsui.R.id.menu_settings);
        ...
        if (doc.isDirectory()) {
            ...
            try {
                ...
                try {
                    ...
                    Toast.makeText(this, top.itmp.documentsui.R.string.toast_no_application, Toast.LENGTH_SHORT).show();
                }
            }
...
//                ContentProviderClient.releaseQuietly(client);
        ...
        protected void onPostExecute(Uri result) {
            if (result != null) {
                ...
                Toast.makeText(DocumentsActivity.this, top.itmp.documentsui.R.string.save_error, Toast.LENGTH_SHORT)
                        .show();
            }
