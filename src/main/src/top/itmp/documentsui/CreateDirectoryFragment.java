...
public class CreateDirectoryFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final View view = dialogInflater.inflate(top.itmp.documentsui.R.layout.dialog_create_dir, null, false);
        final EditText text1 = (EditText) view.findViewById(android.R.id.text1);

        builder.setTitle(top.itmp.documentsui.R.string.menu_create_dir);
    ...
    private class CreateDirectoryTask extends AsyncTask<Void, Void, DocumentInfo> {
        ...
        protected void onPostExecute(DocumentInfo result) {
            if (result != null) {
                ...
                Toast.makeText(mActivity, top.itmp.documentsui.R.string.create_error, Toast.LENGTH_SHORT).show();
            }
