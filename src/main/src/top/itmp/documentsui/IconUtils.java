...
public class IconUtils {
    ...
    static {
        ...
        // Package
        icon = top.itmp.documentsui.R.drawable.ic_doc_apk;
        add("application/vnd.android.package-archive", icon);

        // Audio
        icon = top.itmp.documentsui.R.drawable.ic_doc_audio;
        add("application/ogg", icon);
        add("application/x-flac", icon);

        // Certificate
        icon = top.itmp.documentsui.R.drawable.ic_doc_certificate;
        ...
        // Source code
        icon = top.itmp.documentsui.R.drawable.ic_doc_codes;
        ...
        // Compressed
        icon = top.itmp.documentsui.R.drawable.ic_doc_compressed;
        ...
        // Contact
        icon = top.itmp.documentsui.R.drawable.ic_doc_contact;
        add("text/x-vcard", icon);
        add("text/vcard", icon);

        // Event
        icon = top.itmp.documentsui.R.drawable.ic_doc_event;
        add("text/calendar", icon);
        add("text/x-vcalendar", icon);

        // Font
        icon = top.itmp.documentsui.R.drawable.ic_doc_font;
        ...
        // Image
        icon = top.itmp.documentsui.R.drawable.ic_doc_image;
        ...
        // PDF
        icon = top.itmp.documentsui.R.drawable.ic_doc_pdf;
        add("application/pdf", icon);

        // Presentation
        icon = top.itmp.documentsui.R.drawable.ic_doc_presentation;
        ...
        // Spreadsheet
        icon = top.itmp.documentsui.R.drawable.ic_doc_spreadsheet;
        ...
        // Text
        icon = top.itmp.documentsui.R.drawable.ic_doc_text;
        ...
        // Video
        icon = top.itmp.documentsui.R.drawable.ic_doc_video;
        add("application/x-quicktimeplayer", icon);
        add("application/x-shockwave-flash", icon);

        // Word
        icon = top.itmp.documentsui.R.drawable.ic_doc_word;
        ...
        // Excel
        icon = top.itmp.documentsui.R.drawable.ic_doc_excel;
        ...
        // Powerpoint
        icon = top.itmp.documentsui.R.drawable.ic_doc_powerpoint;
    ...
    public static Drawable loadMimeIcon(
        ...
        if (Document.MIME_TYPE_DIR.equals(mimeType)) {
            ...
            if ("com.android.providers.media.documents".equals(authority)
                ...
                return context.getDrawable(top.itmp.documentsui.R.drawable.ic_doc_album);
            }

            if (mode == DocumentsActivity.State.MODE_GRID) {
                return context.getDrawable(top.itmp.documentsui.R.drawable.ic_grid_folder);
            } else {
                return context.getDrawable(top.itmp.documentsui.R.drawable.ic_doc_folder);
            }
        }
    ...
    public static Drawable loadMimeIcon(Context context, String mimeType) {
        ...
        if ("audio".equals(typeOnly)) {
            return context.getDrawable(top.itmp.documentsui.R.drawable.ic_doc_audio);
        } else if ("image".equals(typeOnly)) {
            return context.getDrawable(top.itmp.documentsui.R.drawable.ic_doc_image);
        } else if ("text".equals(typeOnly)) {
            return context.getDrawable(top.itmp.documentsui.R.drawable.ic_doc_text);
        } else if ("video".equals(typeOnly)) {
            return context.getDrawable(top.itmp.documentsui.R.drawable.ic_doc_video);
        } else {
            return context.getDrawable(top.itmp.documentsui.R.drawable.ic_doc_generic);
        }
    }
