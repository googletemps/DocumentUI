...
public class FailureDialogFragment extends DialogFragment
    ...
    public Dialog onCreateDialog(Bundle inState) {
        ...
        list.append("</p>");
        final String message = String.format(getString(top.itmp.documentsui.R.string.copy_failure_alert_content),
                list.toString());

        return new AlertDialog.Builder(getActivity())
            .setMessage(Html.fromHtml(message))
            .setPositiveButton(top.itmp.documentsui.R.string.retry, this)
