...
public class CopyService extends IntentService {
    ...
    public static void start(Context context, List<DocumentInfo> srcDocs, DocumentStack dstStack) {
        ...
        Toast.makeText(context,
                res.getQuantityString(top.itmp.documentsui.R.plurals.copy_begin, srcDocs.size(), srcDocs.size()),
            ...
            if (mFailedFiles.size() > 0) {
                ...
                final Notification.Builder errorBuilder = new Notification.Builder(this)
                        .setContentTitle(context.getResources().
                                getQuantityString(top.itmp.documentsui.R.plurals.copy_error_notification_title,
                                        mFailedFiles.size(), mFailedFiles.size()))
                        .setContentText(getString(top.itmp.documentsui.R.string.notification_touch_for_details))
                        .setContentIntent(PendingIntent.getActivity(context, 0, navigateIntent,
                                PendingIntent.FLAG_UPDATE_CURRENT | PendingIntent.FLAG_ONE_SHOT))
                        .setCategory(Notification.CATEGORY_ERROR)
                        .setSmallIcon(top.itmp.documentsui.R.drawable.ic_menu_copy)
                        .setAutoCancel(true);
    ...
    private void setupCopyJob(ArrayList<DocumentInfo> srcs, DocumentStack stack)
        ...
        mProgressBuilder = new Notification.Builder(this)
                .setContentTitle(getString(top.itmp.documentsui.R.string.copy_notification_title))
        ...
        mProgressBuilder.addAction(top.itmp.documentsui.R.drawable.ic_cab_cancel,
        ...
        mProgressBuilder.setContentText(getString(top.itmp.documentsui.R.string.copy_preparing));
    ...
    private void makeProgress(long bytesCopied) {
        ...
        if (currentTime - mLastNotificationTime > 1000) {
            ...
            if (mRemainingTime > 0) {
                mProgressBuilder.setContentText(getString(top.itmp.documentsui.R.string.copy_remaining,
    ...
    public static CharSequence formatDuration(long millis) {
        ...
        if (millis >= HOUR_IN_MILLIS) {
            ...
            return res.getQuantityString(
                    top.itmp.documentsui.R.plurals.duration_hours, hours, hours);
        } else if (millis >= MINUTE_IN_MILLIS) {
            final int minutes = (int) ((millis + 30000) / MINUTE_IN_MILLIS);
            return res.getQuantityString(
                    top.itmp.documentsui.R.plurals.duration_minutes, minutes, minutes);
        } else {
            final int seconds = (int) ((millis + 500) / SECOND_IN_MILLIS);
            return res.getQuantityString(
                    top.itmp.documentsui.R.plurals.duration_seconds, seconds, seconds);
        }
    }
    /**
